            ...
            <div className="film-card__desc">
              ...
              <div className="film-card__reviews film-card__row">
                <div className="film-card__reviews-col">
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">Anderson&rsquo;s films are too precious for some, but for those of us willing to lose ourselves in them, they&rsquo;re a delight. &rdquoThe Grand Budapest Hotel&rdquo is no different, except that he has added a hint of gravitas to the mix, improving the recipe.</p>
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">I didn’t find it amusing, and while I can appreciate the creativity, it&rsquo;s an hour and 40 minutes I wish I could take back.</p>
